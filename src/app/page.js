...
const Home = () => {
    return (
        ...
        <div className="min-h-screen flex flex-col">
          ...
          <section id="new-features" className="flex-grow flex flex-col justify-center bg-white">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 w-full">
              ...
              <div className="grid grid-cols-1 mt-10 text-center sm:mt-12 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0">
                ...
                <div className="flex flex-col justify-center items-center">
                  ...
                  <h3 className="mt-8 text-xl font-bold text-gray-900">Advanced Analytics</h3>
                ...
                <div className="flex flex-col justify-center items-center">
                  ...
                  <h3 className="mt-8 text-xl font-bold text-gray-900">Fast Integration</h3>
                  <p className="mt-4 text-base text-gray-600">
                ...
                <div className="flex flex-col justify-center items-center">
                  ...
                  <h3 className="mt-8 text-xl font-bold text-gray-900">Security First</h3>
                  <p className="mt-4 text-base text-gray-600">
                ...
                <div className="flex flex-col justify-center items-center">
                  ...
                  <h3 className="mt-8 text-xl font-bold text-gray-900">Cloud Integration</h3>
                  <p className="mt-4 text-base text-gray-600">
                ...
                <div className="flex flex-col justify-center items-center">
                  ...
                  <h3 className="mt-8 text-xl font-bold text-gray-900">Task Management</h3>
                  <p className="mt-4 text-base text-gray-600">
                ...
                <div className="flex flex-col justify-center items-center">
                  ...
                  <h3 className="mt-8 text-xl font-bold text-gray-900">Performance Metrics</h3>
                  <p className="mt-4 text-base text-gray-600">
